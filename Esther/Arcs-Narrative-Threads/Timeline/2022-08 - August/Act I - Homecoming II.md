---
Class: Scene              # Type: Scene, Beat, Backdrop
Act: 1              # Which act (1-3)
When: 2026-01-14            # Story chronology date (YYYY-MM-DD 12:30pm)
...
Character: Hero  # Characters in the scene (use array format below for multiple)
POV:                      # blank, first, you, third, omni, narrator, two, all, count
Status: Todo              # Scene status (Todo/Working/Complete)
Due: 2026-01-14             # Target completion date (YYYY-MM-DD). When setting Scene to Complete, change this to that day's date for better novel completion estimate
